...
PCA_LHS <- ggplot(pc_scores, aes(x = PC1, y = PC2, color = life_history_stage)) +
  ...
  xlim(-400, 150) +
  ylim(-150, 150) +
  labs(title = "PCA: Life history stage", x = "PC1 (24.15%)", y = "PC2 (12.38%)", color = "Life history stage")
...
PCA_Y <- ggplot(pc_scores, aes(x = PC1, y = PC2, color = year)) +
  ...
  xlim(-400, 150) +
  ylim(-150, 150) +
  labs(title = "PCA: Season", x = "PC1 (24.15%)", y = "PC2 (12.38%)", color = "Season")
...
PCA_TP <- ggplot(pc_scores, aes(x = PC1, y = PC2, color = group)) +
  ...
  xlim(-400, 150) +
  ylim(-150, 150) +
  labs(title = "PCA: Time point", x = "PC1 (24.15%)", y = "PC2 (12.38%)", color = "Time point")
...
PCA_C <- ggplot(pc_scores, aes(x = PC1, y = PC2, color = colony)) +
  ...
  xlim(-400, 150) +
  ylim(-150, 150) +
  labs(title = "PCA: Colony", x = "PC1 (24.15%)", y = "PC2 (12.38%)", color = "Colony")
...
ann_colors <- list(
  ...
  LHS = c(Mother = "#8B1B1E", Pup = "#C46A00")
)
```
...
heatmap_interaction <- pheatmap(matrix_interaction,
                       ...
                       fontsize_col = 7,
                       fontsize_row = 6,
                       main = "Interaction: Time point & life history stage")
