...
```{r}
clrs <- c("Upregulated" = "lightsalmon1", "Downregulated" = "mediumpurple2", "Not Significant" = "grey20")
...
tp_plot <- ggplot(Allgenes_tp, aes(x = logFC, y = -log10(P.Value), color = Significance, size = Significance)) +
  ...
  labs(title = "(a) Time point (End VS Start)", x = "Log2 fold change", y = "-Log10 P-value") +
  theme_classic() +
  ylim(0,60) +
  xlim(-4,4) +
  theme(
...
lhs_plot <- ggplot(Allgenes_lhs, aes(x = logFC, y = -log10(P.Value), color = Significance, size = Significance)) +
  ...
  scale_color_manual(values = clrs) +  
  scale_size_manual(values = c(1.5, 0.5, 1.5)) +
  labs(title = "(b) Life history stage (Adult VS Pup)", x = "Log2 fold change", y = "-Log10 P-value") +
  theme_classic() +
  #ylim(0,60) +
  #xlim(-4,4) +
    theme(
...
c_plot <- ggplot(Allgenes_c, aes(x = logFC, y = -log10(P.Value), color = Significance, size = Significance)) +
  ...
  labs(title = "(d) Colony (SSB VS FWB)", x = "Log2 fold change", y = "-Log10 P-value") +
  theme_classic() +
  ylim(0,60) +
  xlim(-4,4) +
    theme(
...
y_plot <- ggplot(Allgenes_y, aes(x = logFC, y = -log10(P.Value), color = Significance, size = Significance)) +
  ...
  scale_color_manual(values = clrs) +  
  scale_size_manual(values = 0.5) +
  labs(title = "(c) Season (2019 VS 2020)", x = "Log2 fold change", y = "-Log10 P-value") +
  theme_classic() +
  ylim(0,60) +
  xlim(-4,4) +
    theme(
...
y_plot <- y_plot + theme(text = element_text(family = "sans", size = 10)) +
  theme(legend.title = element_blank())
lhs_plot <- lhs_plot + theme(text = element_text(family = "sans", size = 10)) +
  theme(legend.title = element_blank())
c_plot <- c_plot + theme(text = element_text(family = "sans", size = 10)) +
  theme(legend.title = element_blank())
tp_plot <- tp_plot + theme(text = element_text(family = "sans", size = 10)) +
  theme(legend.title = element_blank())
