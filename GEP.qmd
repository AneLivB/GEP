...
ggsave(here::here("Plots","PCA_plots.png"), plot = PCA_plots, width = 10, height = 4, dpi = 600)
```
...
ggsave(here::here("Plots","heatmap_tp.png"), plot = heatmap_tp, width = 3.5, height = 7, dpi = 600)
```
...
ggsave(here::here("Plots","heatmap_lhs.png"), plot = heatmap_lhs, width = 8, height = 12, dpi = 600)
```
