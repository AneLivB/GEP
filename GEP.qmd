...
ggsave(here::here("Plots","Bubble_TP.png"), plot = plot_TP + fig_theme + theme(legend.position = "none", axis.title.x = element_blank()), width = 4, height = 4, dpi = 600)
```
...
ggsave(here::here("Plots","Bubble_LHS.png"), plot = plot_LHS + fig_theme + theme(legend.position = "none"), width = 4, height = 4, dpi = 600)  
```
