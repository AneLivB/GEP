...
PCA_C <- ggplot(pc_scores, aes(x = PC1, y = PC2, color = colony, shape = colony)) +
  ...
  xlim(-200, 200) +
  ylim(-200, 200) +  
  labs(title = "(a) Social density", x = "PC1 (23 %)", y = "PC2 (13 %)", color = NULL, shape = NULL)
...
In this section, we will perform differential gene expression analysis to identify genes that are differentially expressed between the four main contrasts: Time point, Life history stage, Colony and Season.
...
Correcting for the white blood cell ratio does slightly change the differentially expressed genes, so we'll retain both and compare them moving forward. \### Heatmap
...
#| label: heatmap_lhs
#| echo: FALSE
#Create heatmap for differentially expressed genes between life history stages
...
In this section, we are conducting a gene ontology (GO) enrichment analysis using Clusterprofiler to identify biological processes significantly associated with differentially expressed genes.
