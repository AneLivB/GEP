...
GO_end_vs_start_UP <- enrichGO(Upregulated_end_vs_start_WBC$GeneSymbol,
                       OrgDb = org.Hs.eg.db,
                       universe = Background_tp_combined$GeneSymbol,
                       keyType = "SYMBOL",
                       ont = "BP",
...
GO_adult_vs_pup_DOWN <- enrichGO(Downregulated_adult_vs_pup_WBC$GeneSymbol,
                       OrgDb = org.Hs.eg.db,
...
GO_adult_vs_pup_UP <- enrichGO(Upregulated_adult_vs_pup_WBC$GeneSymbol,
                       OrgDb = org.Hs.eg.db,
                       universe = Background_lhs_combined$GeneSymbol,
                       keyType = "SYMBOL",
                       ont = "BP",
